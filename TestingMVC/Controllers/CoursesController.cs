...
namespace TestingMVC.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Degree,MinDegee,Hours,DeptId,isDeleted")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Degree,MinDegee,Hours,DeptId,isDeleted")] Course course)
        {
            if (id != course.Id)
            {
                return NotFound();
